...
from app.handlers import admin, balance, core, gifts, payments, auto, start, topup_custom, autobuy_settings
from app.metrics import payments_total, purchases_total
from app.utils.logging import setup_logging
from app.handlers import settings as settings_router 
...
dp.include_router(topup_custom.router)
dp.include_router(autobuy_settings.router)
...
for collector in (counter, payments_total, purchases_total):
    try:
